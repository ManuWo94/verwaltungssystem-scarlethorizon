    ...
    elseif (isset($_POST['action']) && $_POST['action'] === 'add_verdict') {
        ...
        if (empty($verdictText)) {
            ...
            if (updateRecord('civil_cases.json', $caseId, $updatedCase)) {
                ...
                // Historie beim Parteienn ergänzen
...
ANTRAG:
Der Parteien, {$caseData['plaintiff']}, wird wegen {$caseData['dispute_subject']} angeklagt.
                        ...
                        <div class="card-body">
                            <form method="post" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $allPlaintiffs = loadJsonData('plaintiffs.json'); ?>
                            ...
                            <div class="card-body">
                                ...
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    addChargeButton.addEventListener('click', function() {
                                        ...
                                        `;
                                        dispute_subjectsContainer.appendChild(newChargeItem);
...
<script>
document.addEventListener('DOMContentLoaded', function() {
    const plaintiffsData = <?php echo json_encode(loadJsonData('plaintiffs.json'), JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP); ?>;
