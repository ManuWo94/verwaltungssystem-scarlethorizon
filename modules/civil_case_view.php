...
// Enforce view permission for cases
...
$case_id = $_GET['id'];
$case = findById('civil_cases.json', $case_id);
$plaintiffRecord = null;
if ($case && isset($case['plaintiff_id'])) {
    $plaintiffRecord = findById('plaintiffs.json', $case['plaintiff_id']);
}
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 main-content">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div>
                    <a href="civil_cases.php" class="btn btn-secondary">
                        <span data-feather="arrow-left"></span> Zurück zur Fallübersicht
                    </a>
                    <a href="civil_case_edit.php?id=<?php echo $case_id; ?>" class="btn btn-primary">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <th style="width: 30%">Kläger</th>
                                        <td>
                                            <?php echo htmlspecialchars($case['plaintiff']); ?>
                                            <?php if ($plaintiffRecord && !empty($plaintiffRecord['tg_number'])): ?>
                                                <br><small class="text-muted">TG: <?php echo htmlspecialchars($plaintiffRecord['tg_number']); ?></small>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>Streitwert</th>
                                        <td><?php echo htmlspecialchars($case['dispute_value'] ?? ''); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Staatsanwalt</th>
                                ...
                                <?php if ($plaintiffRecord && !empty($plaintiffRecord['history'])): ?>
                                    <h6 class="mt-3">Historie des Parteienn</h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if (!empty($entry['case_id'])): ?>
                                                                <div><small class="text-muted">Fall: <a href="civil_case_view.php?id=<?php echo htmlspecialchars($entry['case_id']); ?>"><?php echo htmlspecialchars($entry['case_id']); ?></a></small></div>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <?php if (!empty($case['plea_deal']['reduced_dispute_subject'])): ?>
                                                    <p><strong>Reduzierte Streitgegenstand:</strong> <?php echo htmlspecialchars($case['plea_deal']['reduced_dispute_subject']); ?></p>
                                                <?php endif; ?>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <?php if ($dealStatus === 'pending' && ($isPlaintiff || $isJudge || $isLeadership)): ?>
                                            <div class="mt-3">
                                                <form method="post" action="civil_case_edit.php">
